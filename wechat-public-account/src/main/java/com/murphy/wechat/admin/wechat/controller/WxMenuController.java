...
public class WxMenuController implements WxMpMenuService {
	...
	public String menuCreateSample() throws WxErrorException {
		...
		String searchUrl = wxService.oauth2buildAuthorizationUrl(host+"/wechat/user/authorize", WxConsts.OAuth2Scope.SNSAPI_USERINFO, "aaa");
		button31.setUrl(searchUrl);
